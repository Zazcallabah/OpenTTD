...
static inline RailTileType GetRailTileType(const Tindex &t)
{
 ...
 */
template <typename Tindex>
static inline bool IsPlainRail(const Tindex &t)
{
 ...
 */
template <typename Tindex>
static inline bool IsPlainRailTile(const Tindex &t)
{
 ...
 */
template <typename Tindex>
static inline void SetHasSignals(const Tindex &tile, bool signals)
{
 ...
 */
template <typename Tindex>
static inline bool IsRailDepot(const Tindex &t)
{
 ...
 */
template <typename Tindex>
static inline bool IsRailDepotTile(const Tindex &t)
{
 ...
 */
template <typename Tindex>
static inline RailType GetRailType(const Tindex &t)
{
 ...
 */
template <typename Tindex>
static inline void SetRailType(const Tindex &t, RailType r)
{
 ...
 */
template <typename Tindex>
static inline TrackBits GetTrackBits(const Tindex &tile)
{
	assert(IsPlainRailTile(tile));
 ...
 */
template <typename Tindex>
static inline void SetTrackBits(const Tindex &t, TrackBits b)
{
 ...
 */
template <typename Tindex>
static inline bool HasTrack(const Tindex &tile, Track track)
{
 ...
 */
template <typename Tindex>
static inline DiagDirection GetRailDepotDirection(const Tindex &t)
{
 ...
 */
template <typename Tindex>
static inline Track GetRailDepotTrack(const Tindex &t)
{
...
template <typename Tindex>
static inline SignalType GetSignalType(const Tindex &t, Track track)
{
...
template <typename Tindex>
static inline void SetSignalType(const Tindex &t, Track track, SignalType s)
{
	assert(GetRailTileType(t) == RAIL_TILE_SIGNALS);
	byte pos = (track == TRACK_LOWER || track == TRACK_RIGHT) ? 4 : 0;
...
template <typename Tindex>
static inline void CycleSignalSide(const Tindex &t, Track track)
{
	byte sig;
...
template <typename Tindex>
static inline SignalVariant GetSignalVariant(const Tindex &t, Track track)
{
...
template <typename Tindex>
static inline void SetSignalVariant(const Tindex &t, Track track, SignalVariant v)
{
	byte pos = (track == TRACK_LOWER || track == TRACK_RIGHT) ? 7 : 3;
 ...
 */
template <typename Tindex>
static inline void SetPresentSignals(const Tindex &tile, uint signals)
{
 ...
 */
template <typename Tindex>
static inline uint GetPresentSignals(const Tindex &tile)
{
 ...
 */
template <typename Tindex>
static inline bool HasSignalOnTrack(const Tindex &tile, Track track)
{
 ...
 */
template <typename Tindex>
static inline bool HasSignalOnTrackdir(const Tindex &tile, Trackdir trackdir)
{
...
RailType GetTileRailType(GenericTileIndex tile);
...
template <typename Tindex>
static inline void MakeRailNormal(const Tindex &t, Owner o, TrackBits b, RailType r)
{
...
template <typename Tindex>
inline void MakeRailDepot(const Tindex &t, Owner o, DepotID did, DiagDirection d, RailType r)
{
	SetTileType(t, MP_RAILWAY);
	SetTileOwner(t, o);
	GetTile(t)->m2 = did;

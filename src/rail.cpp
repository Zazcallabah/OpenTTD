...
static inline RailType GetTileRailType(const Tindex &tile)
{
...
/** @copydoc GetTileRailType(const Tindex&) */
RailType GetTileRailType(TileIndex tile)
{
	return GetTileRailType<TileIndex>(tile);
}

/** @copydoc GetTileRailType(const Tindex&) */
RailType GetTileRailType(GenericTileIndex tile)
{
	return GetTileRailType<GenericTileIndex>(tile);
}
